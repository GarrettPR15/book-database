...
public class LabTestHarness1 {
    ...
    public static void main(String[] args) {
        ...
        failures += booleanToInt(bookHasToStringWithoutNumber("book", "author", 
            2));
        ...
        failures += booleanToInt(seriesHasToStringWithBooks(test1, test2, "a", 
            "b"));
    ...
    public static boolean seriesHasToStringWithBooks(Book x, Book y, String z, 
String a){
        Series s = new Series(x);
        s.setAuthor(z);
        s.setTitle(a);
        s.addBook(y);
        return s.toString().contains(x.toString()) && 
s.toString().contains(z.toString());
    }
